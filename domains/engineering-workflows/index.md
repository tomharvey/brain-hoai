...
- **Individual AI productivity has improved in engineering; team-level practice has not.** ~50/50 split now actively not writing code vs still constrained by old habits. But no one is leading toward shared norms: style guides, spec-driven development, architectural logs. Chris is further along and more open than given credit for. Three concrete levers identified (style guide corpus, arch design logs, spec-driven dev) — all need whole-team buy-in. This is a leadership gap (Tom, Jordi, Fergus, Chris as proxy), not a senior/junior gap. Engineers not sharing what they've built — not hiding it, just not broadcasting. Ishmael and Javier may want to lead this but haven't been given explicit space. → [[AI-123]] ([[2026-06-17-ai-provocation-engineering]])
- **Submissions pipeline has been 4 people for 2 months without reaching production.** No clear version-zero milestone defined; priorities shift in conversation. Fergus offered to drop in and unblock — would solve "get something end-to-end" but not the deeper team practice problem. Separate from but related to the team-level AI practice question. ([[2026-06-17-ai-provocation-engineering]])
- **The evolutionary leap from "AI helps me code" to "AI IS the code" is the next frontier — and no engineer is there yet.** Tom is at this point; the team is 2–3 months behind. Skills testing is still manual, not automated — meaning engineers aren't hitting harness problems, which means they're not leaning on AI hard enough. Fergus offered this as a direct challenge to Tom: "Aligning around the state of the art — I don't know how to. That's an offer to you." A retro on submissions pipeline won't work; a greenfield hackathon won't transfer. The on-ramp that has worked: Jordi's quality/testing work (Chris: "100x more tests"). → [[AI-124]] ([[2026-06-19-fergus-tom-weekly]])
- **Deterministic vs non-deterministic tooling distinction is not yet in the pricing team's vernacular.** Wrong GWP figure shown to Admiral because Claude rebuilt datasets from scratch instead of calling frozen Looker queries. Harry identified the problem independently; buy-in for deterministic reporting is the next step. → [[AI-121]] ([[2026-06-17-harry-dowrick-ai-hackathon]])
- **The self-healing loop is the target engineering operating model.** Concept named explicitly by Fergus (Jun 25): agents auto-solve incoming tickets; engineers review and approve PRs rather than writing code. The Harness (structured system for agents to execute against architectural principles) is the enabling infrastructure. Engineers' role shifts from code author to code reviewer/architect. The Finance installments work — Fergus built 80% overnight with Claude — demonstrated this is not theoretical. ([[2026-06-25-fergus-tom-weekly]])
- **Engineering team is "frozen" — fear response, not laziness.** Likely rooted in haulage replatform trauma. The trigger for unfreezing: a 2-day hacking session with Geran, Harvey, and Joanne (new contractor joining next Friday). Fergus is leading this. "Punching cards" framing (engineers as infrastructure workers, not artisans) landed as a grenade — useful for provoking conversation, counterproductive as messaging. Tending the garden vs buying a melon framing works better. ([[2026-06-25-fergus-tom-weekly]])
- **Spec-driven development + TDD are confirmed as team practices.** Chris is doing significantly more tests by asking the agent to test what it writes. Tom's personal workflow: test plan → PR deviation notes. Javier stores plan files in project folders as architectural artefacts; Ishmael discards them (treats them as scaffolding, not output). No team standard yet. ([[2026-06-24-ai-group-therapy]])
