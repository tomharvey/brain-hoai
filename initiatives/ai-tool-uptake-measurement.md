...
- [ ] Act on screen flags: score-or-file the unscored actives (Antton, Charlie Dowrick, Joan Canellas, craig.hill…; Alex Smith has left Flock); identify jai.patel@ (in Anthropic export, unrecognised — check claude.ai admin members); review Stage-2-but-power four (Phoebe, Fred, Milan, Michael Matthews); resolve Geran frontmatter-4-vs-body-3 mismatch
