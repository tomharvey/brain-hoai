...
## Slide 3 — Almost everyone is past first contact; the two people at Stage 1 are blocked, not unwilling
...
- **Bridge from what Tom told Ed on Jun 24** (claims → recalibrated data):
  ...
  - "90% activated" → **96% of scored / 84% of scope**. The mechanism claimed was right: of the nine not counted, seven are simply unmeasured; only two are confirmed below the line — and both are blocked, not stalled.
  - "75% building their own tools" → Stage 3+ proxy gives **65% of scored**; the artifact audit says 51% strict / 71% loose — see Slide 4.
  - "Finance and underwriting lag, broad distribution" → both confirmed lowest by mean (2.3 / 2.5). Finance is genuinely broad (Stage 1–4, the CFO at the top and both Stage-1s in it); UW is the tightest cluster in the company (everyone at 2–3, no stars, no stragglers).
...
**Presenter notes**
- Artifact-level audit, Jul 2: one agent per team verified every claim against people files + transcripts. Rubric: builder = named, reusable artifact they created with AI (skill, dashboard, automation, MCP workflow, app, pipeline) in repeated use. 25 verified / 10 assisted / 14 no-artifact of 49.
- This slide is the honest version of the "75% building their own tools" claim from Jun 24: roughly right under the loose definition (71%), ahead of the evidence under the strict one (51%). Say which definition you mean.
- The Stage 3+ proxy (65%) over- and under-counts builders both ways — full mismatch list in the builder-audit appendix (e.g. Darren McC at Stage 3 with no artifact; Milan at Stage 2 with two corroborated skills).
